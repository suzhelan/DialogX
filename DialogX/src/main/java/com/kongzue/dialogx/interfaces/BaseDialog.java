...
public abstract class BaseDialog implements LifecycleOwner {
    ...
    public View createView(int layoutId) {
        if (isActivityImplMode()) {
            ...
            return FixContextUtil.getFixInflater(getOwnActivity()).inflate(layoutId, null);
        } else {
            return FixContextUtil.getFixInflater(getApplicationContext()).inflate(layoutId, null);
        }
    }
